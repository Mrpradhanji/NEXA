        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <dl className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full mt-8">
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 text-center hover:scale-[1.02] transition-all duration-300 h-full flex flex-col justify-center">
