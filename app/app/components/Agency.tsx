  ...
  <section className="bg-gray-200 min-h-screen text-black px-8 py-10 flex flex-col items-center font-sans relative">
    <div className="max-w-4xl w-full">
      ...
      <p className="text-lg mb-8 mt-6 text-center">
        ...
        targeted tools available, as well as the ability to provide customer
        support - in other words, opportunities too good to be missed by a
        business.
      </p>
      <p className="text-lg mb-8 text-center">
        When working with a Digital Marketing Agency, they will cater to your
        specific needs, since not all digital marketing methods will be
      ...
      <div className="grid md:grid-cols-2 gap-10">
        <div>
          <p className="text-lg">
            ...
            marketing, with the focus being placed on leads.
          </p>
        </div>
        <div>
          <p className="text-lg">
            Your team of marketers will place a keen interest in developing
            relationships with your audience. Providing value and encouraging
            engagement is of the utmost importance, which is then followed by
