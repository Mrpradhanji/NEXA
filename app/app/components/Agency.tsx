  ...
  <section className="bg-gray-200 min-h-screen text-black px-8 py-10 flex flex-col items-center font-sans relative">
    <div className="max-w-4xl w-full">
      ...
      <p className="text-lg mb-8 text-center">
        When working with a Digital Marketing Agency, they will cater to your specific needs, since not all digital marketing methods will be applicable to you. However, having a well rounded and well-executed strategy is paramount. The agency you work with should be experienced in your industry, with a portfolio of work to show for it. We invite you to have a look at the businesses we’ve worked with, assisting them with various marketing services that have helped them level up.
      </p>
      <hr className="border-gray-800 my-10" />
      <div className="grid md:grid-cols-2 gap-10">
        <div>
          <p className="text-lg">
            When the Digital Marketing Agency begins working with you, they will develop a strategy which includes specific goals and plans. It includes extensive research and will map out your business’s planned digital footprint. They will then call on their team of creatives to work on the content creation, which should be designed to satisfy and convert your audiences. It will include various forms of digital marketing, with the focus being placed on leads.
          </p>
        </div>
        <div>
          <p className="text-lg">
    ...
    {/* Decorative images roughly as shown in the screenshot */}
