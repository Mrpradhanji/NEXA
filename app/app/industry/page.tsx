...
import { FaBullseye, FaChartLine, FaBalanceScale, FaComments, FaSearch, FaChartBar } from "react-icons/fa";
  ...
  const benefits = [
    {
      ...
      icon: <FaBullseye className="text-orange-500 w-12 h-12 mx-auto transition-transform duration-500 transform group-hover:scale-125" />
    },
    {
      title: "Proven Strategies",
      description: "Our approaches are tested and refined through years of experience across diverse sectors.",
      icon: <FaChartLine className="text-green-500 w-12 h-12 mx-auto transition-transform duration-500 transform group-hover:scale-125" />
    },
    {
      title: "Compliance Expertise",
      description: "We navigate complex industry regulations while maintaining effective marketing strategies.",
      icon: <FaBalanceScale className="text-yellow-500 w-12 h-12 mx-auto transition-transform duration-500 transform group-hover:scale-125" />
    },
    {
      title: "Targeted Messaging",
      description: "We craft messages that resonate with your specific audience and industry context.",
      icon: <FaComments className="text-purple-500 w-12 h-12 mx-auto transition-transform duration-500 transform group-hover:scale-125" />
    },
    {
      title: "Competitive Intelligence",
      description: "We stay ahead of industry trends and competitor strategies to keep you competitive.",
      icon: <FaSearch className="text-blue-500 w-12 h-12 mx-auto transition-transform duration-500 transform group-hover:scale-125" />
    },
    {
      title: "Measurable Results",
      description: "We focus on KPIs that matter most to your industry and business objectives.",
      icon: <FaChartBar className="text-indigo-500 w-12 h-12 mx-auto transition-transform duration-500 transform group-hover:scale-125" />
    }
  ];
