            ...
            <AnimatePresence>
              {filteredProjects.map((project) => (
                ...
                >
                  ...
                  <div className="p-6">
                    <p className="text-black leading-relaxed mb-4">{project.description}</p>

                    <div className="mb-4">
                      <h4 className="text-black font-semibold mb-2">Key Results:</h4>
                      <ul className="space-y-1">
                        {project.results.map((result, idx) => (
                          <li key={idx} className="text-black text-sm flex items-center">
